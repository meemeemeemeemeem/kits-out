...
//		return (Map<String,Collection<ConfigAttribute>>)redisClientTemplate.get(urlId, String.class);
	}
	...
	public void initComponentMetadata(){
		...
		for(String key:cacheMap.keySet()){
			...
			// redis缓存自定义控件显示配置表 update by lb 2017/3/3
//			redisClientTemplate.del(key);
//			redisClientTemplate.set(key, cacheMap.get(key));
		}
	}
