...
//head.insertBeforle(oscript, head.firstChild);
...
function getLodop(oOBJECT, oEMBED) {
	...
	try {
		...
		if (!LODOP && document.readyState !== "complete") {
			dorado.MessageBox.alert("C-Lodop没准备好，请稍后再试！");
			return;
		}
		;
		...
		LODOP.SET_LICENSES("","003F504028A56C18252660C35A66A114","C94CEE276DB2187AE6B65D56B3FC2848","");
		return LODOP;
	} catch (err) {
//		alert("getLodop出错:" + err);
		dorado.MessageBox.alert("请安装打印插件C-Lodop！");
	}
	;
};
