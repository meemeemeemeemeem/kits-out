...
@Entity
@Table(name = "TBBS012")
public class Tbbs012 implements Serializable {
	 ...
	 * PK_BS012_:
	 */
	@PropertyDef(label = "PK_BS012_", description = "PK_BS012_:")
	private String pkBs012;
	 ...
	 * COMP_ADDR_:
	 */
	@PropertyDef(label = "COMP_ADDR_", description = "COMP_ADDR_:")
	...
	public Tbbs012(String pkBs012, String compId, String custNo,
			String custName, String compName, String taxNumber,
			String compPhone, String compAddr, String bankNo,
			String bankAccount, String zipeCode, String invoiceAddress,
			String memo, String createEmp, Date createDate, String modifyEmp,
	...
	public void setPkBs012(String pkBs012) {
		this.pkBs012 = pkBs012;
	}

	@Id
	@Column(name = "PK_BS012_", length = 10, nullable = false)
	public String getPkBs012() {
		return pkBs012;
	}
	...
	@Column(name = "COMP_NAME_", length = 40)
	...
	@Column(name = "COMP_ADDR_", length = 100)
	...
	@Column(name = "ZIPE_CODE_", length = 10)
	...
	@Column(name = "INVOICE_ADDRESS_", length = 40)
	...
	public String toString() {
		return "Tbbs012 [pkBs012=" + pkBs012 + ",compId=" + compId + ",custNo="
				+ custNo + ",custName=" + custName + ",compName=" + compName
				+ ",taxNumber=" + taxNumber + ",compPhone=" + compPhone
				+ ",compAddr=" + compAddr + ",bankNo=" + bankNo
				+ ",bankAccount=" + bankAccount + ",zipeCode=" + zipeCode
				+ ",invoiceAddress=" + invoiceAddress + ",memo=" + memo
