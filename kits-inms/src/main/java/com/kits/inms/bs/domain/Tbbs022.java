...
@Entity
@Table(name = "TBBS022")
public class Tbbs022 implements Serializable {
	 ...
	 * PK_BS022_:
	 */
	@PropertyDef(label = "PK_BS022_", description = "PK_BS022_:")
	private String pkBs022;
	 ...
	 * TYP_:
	 */
	@PropertyDef(label = "TYP_", description = "TYP_:")
	private String typ;
	...
	public Tbbs022(String pkBs022, String compId, String prodeNo,
			...
			String typ, String pid) {
		super();
		this.pkBs022 = pkBs022;
		this.compId = compId;
	...
	public void setPkBs022(String pkBs022) {
		this.pkBs022 = pkBs022;
	}

	@Id
	@Column(name = "PK_BS022_", length = 40, nullable = false)
	public String getPkBs022() {
		return pkBs022;
	}
	...
	public String toString() {
		return "Tbbs022 [pkBs022=" + pkBs022 + ",compId=" + compId
