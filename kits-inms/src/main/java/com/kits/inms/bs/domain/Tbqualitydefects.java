...
/**
 * TBQUALITYDEFECTS:质量缺陷维护
 */
@Entity
@Table(name = "TBQUALITYDEFECTS")
public class Tbqualitydefects implements Serializable {
	 ...
	 * 质量缺陷主键:质量缺陷主键
	 */
	@PropertyDef(label = "质量缺陷主键", description = "质量缺陷主键:质量缺陷主键")
	private String pkQualityDefects;
	 ...
	 * 质量缺陷代码:质量缺陷代码
	 */
	@PropertyDef(label = "质量缺陷代码", description = "质量缺陷代码:质量缺陷代码")
	private String qualityDefectsCode;

	/**
	 * 质量缺陷名称:质量缺陷名称
	 */
	@PropertyDef(label = "质量缺陷名称", description = "质量缺陷名称:质量缺陷名称")
	private String qualityDefectsName;

	/**
	 * 质量缺陷分类:质量缺陷分类
	 */
	@PropertyDef(label = "质量缺陷分类", description = "质量缺陷分类:质量缺陷分类")
	private String qualityDefectsType;
	...
	public Tbqualitydefects() {
		super();
	}

	public Tbqualitydefects(String pkQualityDefects, String compId,
			String qualityDefectsCode, String qualityDefectsName,
			String qualityDefectsType, String createEmpNo, Date createDate,
		...
		super();
		this.pkQualityDefects = pkQualityDefects;
		this.compId = compId;
		this.qualityDefectsCode = qualityDefectsCode;
		this.qualityDefectsName = qualityDefectsName;
		this.qualityDefectsType = qualityDefectsType;
	...
	public void setPkQualityDefects(String pkQualityDefects) {
		this.pkQualityDefects = pkQualityDefects;
	}

	@Id
	@Column(name = "PK_QUALITY_DEFECTS", length = 40, nullable = false)
	public String getPkQualityDefects() {
		return pkQualityDefects;
	}
	...
	public void setQualityDefectsCode(String qualityDefectsCode) {
		this.qualityDefectsCode = qualityDefectsCode;
	}

	@Column(name = "QUALITY_DEFECTS_CODE_", length = 10)
	public String getQualityDefectsCode() {
		return qualityDefectsCode;
	}

	public void setQualityDefectsName(String qualityDefectsName) {
		this.qualityDefectsName = qualityDefectsName;
	}

	@Column(name = "QUALITY_DEFECTS_NAME_", length = 100)
	public String getQualityDefectsName() {
		return qualityDefectsName;
	}

	public void setQualityDefectsType(String qualityDefectsType) {
		this.qualityDefectsType = qualityDefectsType;
	}

	@Column(name = "QUALITY_DEFECTS_TYPE_", length = 4)
	public String getQualityDefectsType() {
		return qualityDefectsType;
	}
	...
	public String toString() {
		return "Tbqualitydefects [pkQualityDefects=" + pkQualityDefects
				+ ",compId=" + compId + ",qualityDefectsCode="
				+ qualityDefectsCode + ",qualityDefectsName="
				+ qualityDefectsName + ",qualityDefectsType="
				+ qualityDefectsType + ",createEmpNo=" + createEmpNo
